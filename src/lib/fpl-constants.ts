...
export const FDR_COLORS: Record<
  number,
...
> = {
  1: {
    ...
    text: "text-white",
    label: "Very Easy",
    border: "border-[#00bb6e]",
  },
  2: {
    bg: "bg-[#01fc7a]",
    text: "text-gray-900",
    label: "Easy",
    border: "border-[#01fc7a]",
  },
  3: {
    bg: "bg-[#e1e5e8]",
    text: "text-gray-800",
  ...
  4: {
    ...
    text: "text-white",
    label: "Hard",
    border: "border-[#ff1751]",
  },
  5: {
    bg: "bg-[#80072d]",
    text: "text-white",
    label: "Very Hard",
    border: "border-[#80072d]",
  },
};
...
export const TEAM_STYLES: Record<
  string,
  { primary: string; secondary: string; text: string; pattern?: string }
> = {
...
// Official Premier League 2024/25+ photoshoot CDN bucket
