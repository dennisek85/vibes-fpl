...
export const UI_TEXT = {
  ...
  telemetry: {
    ...
    detailedRating: (d: number, m: number, f: number) =>
      `(D:${d}% M:${m}% F:${f}%)`,
  },
  gameweekStepper: {
  ...
  tooltips: {
    ...
    threat:
      "Official FPL Threat — gauge of player goal threat and penalty box danger",
    ...
    creativity:
      "Official FPL Creativity — frequency and quality of chance creation for teammates",
    ...
    horizonXp:
      "Cumulative AI Projected Points across the selected Gameweek horizon",
    ...
    transfersToday:
      "Net transfers in/out during the current 24-hour daily cycle",
    velocity:
      "Hourly transfer rate speed (% progress per hour towards price threshold)",
    targetProgress:
      "Percentage progress towards overnight price rise (+100%) or fall (-100%) threshold",
    timing:
      "Estimated timing when price change is forecasted to trigger (e.g. Tonight, Tomorrow)",
    prediction:
      "AI Price prediction status (Rising, Falling, Approaching, Stable)",
    action: "Quick transfer scout and detail actions",
    // Category Group Headers
    categories: {
      playerInfo: "Player identity, club, position, pricing and match minutes",
      goalThreat:
        "Underlying attacking shooting metrics, expected goals & goal conversion",
      involvement:
        "Overall offensive involvement (xG + xA) and total season points",
      creativity:
        "Key passes, expected assists, and chance creation for teammates",
      defensive:
        "Defensive security, expected goals conceded (xGC) and clean sheet equity",
  ...
  analytics: {
    ...
    subtitle:
      "Backtesting OpenFPL Machine Learning recommendations vs. your actual decisions throughout the season.",
    badges: {
    ...
    sections: {
      ...
      driftSubtitle:
        "Cumulative points: Your Actual Team vs. AI Co-Pilot Simulation",
      captainTitle: "The Captaincy Alpha (Armband Analyzer)",
      captainSubtitle:
        "Points comparison between your chosen captain vs. OpenFPL AI Top Captain projection",
      attributionTitle: "Points Attribution Breakdown",
      attributionSubtitle:
        "Decomposing where the AI algorithmic edge originated across the pitch",
      transfersTitle: "Transfer Decision Matrix",
      transfersSubtitle:
        "Comparing your actual weekly transfers against the AI #1 recommended move",
    },
    attribution: {
      cleanSheets: "Clean Sheet Equity",
      cleanSheetsDesc:
        "Points gained from defensive hazard & opponent clean sheet probability models",
      goals: "Goal Threat Conversion",
      goalsDesc:
        "Attacking points captured via xG volume and high-quality box chances",
      assists: "Creativity & Assist Return",
      assistsDesc:
        "Value gained from designated set-piece tracking and open-play xA playmakers",
      bonus: "BPS Magnetism",
      bonusDesc:
        "Bonus points captured by OpenFPL baseline BPS regression algorithms",
  ...
  mlLab: {
    ...
    subtitle:
      "Testing cutting-edge quantitative signals in isolated experimental arms alongside the Production baseline without risking live squad plans.",
    exitLab: "Exit Lab Mode",
    tabs: {
      arms: "🔬 Experimental Arms Leaderboard",
      divergences: "⚡ Key Model Disagreements",
      postMortem: "📑 Post-Mortem Audits",
      architecture: "🏛️ Factorial Design",
    },
    postMortemSection: {
      title: "Gameweek Post-Mortem Audits & Human-in-the-Loop Calibration",
      subtitle:
        "Immutable performance records comparing pre-deadline projections against official match outcomes. The latest completed report is displayed first.",
      stagedBadge: "Staged for Review",
      appliedBadge: "Calibrations Active",
      archivedBadge: "Archived Record",
      accuracyScorecard: "Prediction Accuracy Scorecard",
      overallMaeLabel: "Overall Point MAE",
      correlationLabel: "Pearson Correlation (r)",
      minutesMaeLabel: "Minutes Played MAE",
      positionalBreakdown: "Positional Accuracy (MAE)",
      outliersTitle: "Model Outliers Spotlight",
      overperformedTitle: "Top Over-Performers (Unexpected Hauls)",
      underperformedTitle: "Top Under-Performers (Model Over-Estimation)",
      calibrationsTitle: "Guardrailed Multi-Formula Calibrations (6 Models)",
      calibrationsSubtitle:
        "Conservative Bayesian micro-adjustments strictly clamped within ±5% safety envelopes to eliminate variance runaway.",
      guardrailPassed: "Passed Guardrails (Safe)",
      guardrailBreaker: "Circuit Breaker Tripped (Reverted to Safe Baseline)",
      approveButton: "✅ Approve & Apply Calibrations",
      revertButton: "🔄 Reset to Safe Baseline",
      appliedSuccessNotice: "Calibrations successfully applied to live planning projections.",
      revertSuccessNotice: "Engine reverted to canonical baseline parameters.",
      noReportsNotice: "No completed gameweek reports found. Reports generate automatically upon match finalization.",
    },
    armsSection: {
  ...
  rotationRisk: {
    ...
    subtitle:
      "Pre-deadline starting certainty, sub-risk analysis, and manager rotation hazard indicators.",
    badges: {
    ...
    reasons: {
      managingLoad:
        "Manager is managing player load; high risk of being rested or subbed at 60'.",
      tightness:
        "Muscle tightness reported in training; elevated risk of early substitution or benching.",
      lateFitnessTest:
        "Subject to a late pre-match fitness test; starting spot is unconfirmed.",
      assessed: "Undergoing medical assessment ahead of the weekend fixture.",
      illness:
        "Recovering from illness; stamina and match fitness being evaluated.",
      knock:
      ...
      defaultSafe:
        "Nailed starting regular with optimal physical recovery and zero fitness flags.",
    },
  },
} as const;
